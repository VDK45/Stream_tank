...
def about_game():
    ...
    while run:
        ...
        game_text3 = get_font(25).render("!fire    ", True, "Red")
        game_rect3 = game_text3.get_rect(center=(330, 170))
        game_text4 = get_font(25).render("!shot    ", True, "Red")
        ...
        sub_text4 = get_font(25).render("To shot      ", True, "Black")
        sub_rect4 = sub_text4.get_rect(center=(730, 210))
